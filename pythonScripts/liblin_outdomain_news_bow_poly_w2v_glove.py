...
##WORD2VEC
# InputData FitTransform and Normalized
with open('/mounts/Users/student/ankit/downloads/final_datasets/outdomain/w2v_news_skip_norm.txt', 'rb') as infile:
...
with open('/mounts/Users/student/ankit/downloads/final_datasets/outdomain/w2v_news_skip_norm_test.txt', 'rb') as stfile:
...
## GLOVE
# InputData FitTransform and Normalized
with open('/mounts/Users/student/ankit/downloads/final_datasets/outdomain/glove_news_skip_norm.txt', 'rb') as infile:
   InputDataG_raw = pickle.load(infile)
InputDataG = preprocessing.normalize(InputDataG_raw,norm='l2')

# TestData FitTransform and Normalized
with open('/mounts/Users/student/ankit/downloads/final_datasets/outdomain/glove_news_skip_norm_test.txt', 'rb') as stfile:
...
InputData = hstack((InputDataB,InputDataP, InputDataW, InputDataG))
TestData = hstack((TestDataB,TestDataP,TestDataW, TestDataG))
...
file = open("/mounts/Users/student/ankit/downloads/sentiment/result/output_outdomain_news_bow_poly_w2v_glove.txt", "w")
