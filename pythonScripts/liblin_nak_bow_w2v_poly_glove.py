...
#OutDomain Dataset
with open('/mounts/Users/student/ankit/downloads/newsamazonkaggle/nak_norm_raw.txt') as outf:
    for line in outf:
...
##WORD2VEC
# InputData FitTransform and Normalized
with open('/mounts/Users/student/ankit/downloads/newsamazonkaggle/nak_w2v_train_dataset.txt', 'rb') as infile:
...
with open('/mounts/Users/student/ankit/downloads/newsamazonkaggle/nak_w2v_test_dataset.txt', 'rb') as stfile:
   TestDataW_raw = pickle.load(stfile)
TestDataW = preprocessing.normalize(TestDataW_raw,norm='l2')

## POLYGLOT
# InputData FitTransform and Normalized
with open('/mounts/Users/student/ankit/downloads/newsamazonkaggle/nak_poly_train_dataset.txt', 'rb') as infile:
   InputDataP_raw = pickle.load(infile)
InputDataP = preprocessing.normalize(InputDataP_raw,norm='l2')

# TestData FitTransform and Normalized
with open('/mounts/Users/student/ankit/downloads/newsamazonkaggle/nak_poly_test_dataset.txt', 'rb') as stfile:
   TestDataP_raw = pickle.load(stfile)
TestDataP = preprocessing.normalize(TestDataP_raw,norm='l2')

## GLOVE
# InputData FitTransform and Normalized
with open('/mounts/Users/student/ankit/downloads/newsamazonkaggle/glove_nak_skip_norm.txt', 'rb') as infile:
   InputDataG_raw = pickle.load(infile)
InputDataG = preprocessing.normalize(InputDataG_raw,norm='l2')

# TestData FitTransform and Normalized
with open('/mounts/Users/student/ankit/downloads/newsamazonkaggle/glove_nak_skip_norm_test.txt', 'rb') as stfile:
...
InputData = hstack((InputDataB, InputDataW, InputDataP, InputDataG))
TestData = hstack((TestDataB, TestDataW, TestDataP,TestDataG))
...
file = open("/mounts/Users/student/ankit/downloads/sentiment/result/output_nak_bow_w2v_poly_glove.txt", "w")
