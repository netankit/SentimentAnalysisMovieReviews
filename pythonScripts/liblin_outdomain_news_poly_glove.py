...
InputData = hstack((InputDataP, InputDataW))
TestData = hstack((TestDataP, TestDataW))
...
file = open("/mounts/Users/student/ankit/downloads/sentiment/result/output_outdomain_news_poly_glove.txt", "w")
