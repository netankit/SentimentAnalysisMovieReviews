...
InputData = hstack((InputDataB, InputDataW))
TestData = hstack((TestDataB, TestDataW))
...
file = open("/mounts/Users/student/ankit/downloads/sentiment/result/output_outdomain_news_bow_glove.txt", "w")
