...
InputData = hstack((InputDataB, InputDataW, InputDataP))
TestData = hstack((TestDataB, TestDataW, TestDataP))
...
file = open("/mounts/Users/student/ankit/downloads/sentiment/result/output_nak_bow_w2v_poly.txt", "w")
