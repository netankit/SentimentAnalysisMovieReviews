...
InputData = hstack((InputDataP, InputDataB, InputDataW))
TestData = hstack((TestDataP, TestDataB, TestDataW))
...
file = open("/mounts/Users/student/ankit/downloads/sentiment/result/output_outdomain_news_poly_bow_glove.txt", "w")
