...
InputData = hstack((InputDataW, InputDataP))
TestData = hstack((TestDataW, TestDataP))
...
file = open("/mounts/Users/student/ankit/downloads/sentiment/result/output_outdomain_news_w2v_glove.txt", "w")
